...
export interface StorageArea<BS = any> {
  set<T = any>(key: AllowedKey, value: T, opts?: Options): Promise<void> ;
  get<T = any>(key: AllowedKey, opts?: Options): Promise<T> ;
  ...
  values<T = any>(opts?: Options): AsyncIterableIterator<T>;
  entries<T = any>(opts?: Options): AsyncIterableIterator<[Key, T]>;
